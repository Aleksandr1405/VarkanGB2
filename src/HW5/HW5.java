...
public class HW5 {
    private static void singleThread(float[] arr) {
        ...
        System.out.printf("Время выполнения при однопоточном вычислении: " + singleTime + "\n");
    }
    ...
    private static void multiThread(float[] arr) {
        ...
        MyThread thread1 = new MyThread("a", a);
        MyThread thread2 = new MyThread("b", b);
        ...
        System.out.printf("Время выполнения при многопоточном вычислении: " + multiTime);
    }
